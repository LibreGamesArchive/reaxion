...
/**
 * Straight copy paste of {@code StandardGame}, with extra cleanup relating to
 * Reaxion.
 * @author Khoa Ha
 *
 */
public class ReaxionGame extends AbstractGame implements Runnable {
    ...
    public ReaxionGame(String gameName) {
        this(gameName, GameType.GRAPHICAL, null);
    }

    public ReaxionGame(String gameName, GameType type) {
        this(gameName, type, null);
    }

    public ReaxionGame(String gameName, GameType type, GameSettings settings) {
    ...
    public ReaxionGame(String gameName, GameType type, GameSettings settings, UncaughtExceptionHandler exceptionHandler) {
...
class DefaultUncaughtExceptionHandler implements UncaughtExceptionHandler {
    ...
    private ReaxionGame game;

    public DefaultUncaughtExceptionHandler(ReaxionGame game) {
        this.game = game;
    }
