...
public class FlowerField extends Stage {
	...
	public void act(StageGameState b) {
		...
		if (count == 3) {
			...
			petal.model.setLocalTranslation(24 * FastMath.cos(theta)
					+ playerPos.x, 0, 24 * FastMath.sin(theta) + playerPos.z);
			petal.setVelocity(new Vector3f(FastMath.nextRandomFloat() - .3f, 1,
