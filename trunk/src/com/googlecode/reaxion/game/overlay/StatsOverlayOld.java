...
public class StatsOverlayOld extends MenuOverlay {
	...
	public StatsOverlayOld(PlayerInfo player, PlayerInfo partner) {
	...
	private void init() {
		...
		asd = drawRect(width, height, new ColorRGBA(0,0,0,.67f));
