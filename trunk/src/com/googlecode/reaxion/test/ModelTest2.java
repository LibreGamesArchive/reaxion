 ...
 *
 */
public class ModelTest2 extends SimpleGame {
    private static final Logger logger = Logger
            .getLogger(ModelTest2.class.getName());
    
    AnimationController ac;
    boolean boneOn = false;
    public static void main(String[] args) {
        ModelTest2 app = new ModelTest2();
    ...
    protected void simpleInitGame() {
        try {
            ResourceLocatorTool.addResourceLocator(
                    ...
                    new SimpleResourceLocator(ModelTest2.class
        ...
        InputStream mobboss = ModelTest2.class.getClassLoader()
                .getResourceAsStream("com/googlecode/reaxion/resources/cow.dae");
        ...
        InputStream animation = ModelTest2.class.getClassLoader()
        .getResourceAsStream("com/googlecode/reaxion/resources/cow.dae");
        if (mobboss == null) {
