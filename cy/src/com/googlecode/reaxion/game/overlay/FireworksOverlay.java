...
public class FireworksOverlay extends Overlay {
	...
	public FireworksOverlay() {
        ...
        // Dark Gray
        circleColor = new ColorRGBA(.25f, .25f, .25f, 1);
