 ...
 * @author Khoa
 */
public class SuperHackyRidiculousStageGameStateThatDoesntExtendCameraGameStateXD extends BasicGameState implements StageGameInterface {
	...
	public SuperHackyRidiculousStageGameStateThatDoesntExtendCameraGameStateXD() {
		super(NAME);
		init();
	}

	public SuperHackyRidiculousStageGameStateThatDoesntExtendCameraGameStateXD(Battle b) {
		super(NAME);
		init();
